      ...
      [
        { text: 'Cancel', style: 'cancel' },
        {
          ...
          onPress: () => {
            Alert.alert(
              'Final Confirmation',
              'This is permanent and irreversible. Your account and all associated data will be deleted immediately.',
              [
                { text: 'Cancel', style: 'cancel' },
                {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: c.dark }}>
      ...
      <ScrollView style={{ flex: 1, paddingHorizontal: 20 }} showsVerticalScrollIndicator={false}>
        ...
        {/* ── Log Out ── */}
        <TouchableOpacity
          style={{ backgroundColor: '#FF6B6B18', borderRadius: 16, padding: 16, alignItems: 'center', borderWidth: 1, borderColor: '#FF6B6B44', marginBottom: 12, flexDirection: 'row', justifyContent: 'center', gap: 10 }}
        ...
        {/* ── Delete Account ── */}
        <TouchableOpacity
          style={{ backgroundColor: 'transparent', borderRadius: 16, padding: 14, alignItems: 'center', borderWidth: 1, borderColor: 'rgba(255,107,107,0.2)', marginBottom: 24, flexDirection: 'row', justifyContent: 'center', gap: 8 }}
          onPress={handleDeleteAccount}>
          <Ionicons name="trash-outline" size={16} color="#FF6B6B88" />
          <Text style={{ color: '#FF6B6B88', fontSize: 13, fontWeight: '600' }}>Delete Account</Text>
        </TouchableOpacity>
