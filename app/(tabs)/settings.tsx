    ...
    <View style={{ flex: 1, backgroundColor: c.dark }}>
      ...
      <ScrollView style={{ flex: 1, paddingHorizontal: 20 }} showsVerticalScrollIndicator={false}>
        ...
        <View style={{ backgroundColor: c.card, borderRadius: 20, marginBottom: 20, borderWidth: 1, borderColor: c.border, overflow: 'hidden' }}>
          ...
          <TouchableOpacity onPress={() => Linking.openURL('https://www.instagram.com/jamesfinanceapp').catch(() => { })}
          ...
          <TouchableOpacity onPress={() => Linking.openURL('https://www.tiktok.com/@jamesfinanceapp?_r=1&_t=ZN-94NjuWv6IvW').catch(() => { })}
            style={{ flexDirection: 'row', alignItems: 'center', padding: 16, borderTopWidth: 1, borderTopColor: c.border, gap: 14 }}>
        ...
        {/* ── Delete Account ── */}
        <TouchableOpacity
          style={{ alignItems: 'center', marginBottom: 24, paddingVertical: 10 }}
          onPress={handleDeleteAccount}>
          <Text style={{ color: c.muted + '88', fontSize: 12, fontWeight: '600' }}>Delete Account</Text>
        </TouchableOpacity>
