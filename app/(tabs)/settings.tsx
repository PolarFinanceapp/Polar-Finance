...
const PRIVACY: Record<string, LegalSection[]> = {
  en: [
    ...
    { title: '10. Children', body: 'Polar Finance is not intended for anyone under 18. Contact us at contact@polarfinance.app if you believe a minor has created an account.' },
    ...
    { title: '12. Contact', body: 'Privacy: privacy@polarfinance.app\nGeneral: contact@polarfinance.app\nICO (UK): ico.org.uk' },
  ],
  es: [
    { title: '1. Quiénes Somos', body: 'Polar Finance es una aplicación de finanzas personales.\n\nGeneral: contact@polarfinance.app\nSolicitudes de datos: privacy@polarfinance.app' },
    ...
    { title: '3. Cómo Usamos Tus Datos', body: 'Tus datos se usan únicamente para ofrecer y mejorar Polar Finance. Nunca vendemos tus datos ni los usamos para publicidad.' },
    ...
    { title: '8. Tus Derechos (RGPD)', body: 'Tienes derecho a acceder, corregir, eliminar o portar tus datos. Email: privacy@polarfinance.app — respondemos en 30 días.' },
    ...
    { title: '10. Menores', body: 'Polar Finance no está destinado a menores de 18 años.' },
    { title: '11. Cambios', body: 'Podemos actualizar esta política. El uso continuado implica aceptación.' },
    { title: '12. Contacto', body: 'Privacidad: privacy@polarfinance.app\nGeneral: contact@polarfinance.app' },
  ],
  fr: [
    { title: '1. Qui Sommes-Nous', body: 'Polar Finance est une application de finances personnelles.\n\nContact: contact@polarfinance.app\nDonnées: privacy@polarfinance.app' },
    ...
    { title: '3. Utilisation des Données', body: 'Vos données sont utilisées uniquement pour fournir et améliorer Polar Finance. Nous ne vendons jamais vos données et ne les utilisons pas à des fins publicitaires.' },
    ...
    { title: '8. Vos Droits (RGPD)', body: 'Vous avez le droit d\'accéder, corriger, supprimer ou porter vos données. Email: privacy@polarfinance.app — réponse sous 30 jours.' },
    ...
    { title: '10. Enfants', body: 'Polar Finance n\'est pas destiné aux moins de 18 ans.' },
    { title: '11. Modifications', body: 'Nous pouvons mettre à jour cette politique. L\'utilisation continue vaut acceptation.' },
    { title: '12. Contact', body: 'Confidentialité: privacy@polarfinance.app\nGénéral: contact@polarfinance.app' },
  ],
  de: [
    { title: '1. Wer Wir Sind', body: 'Polar Finance ist eine persönliche Finanz-App.\n\nKontakt: contact@polarfinance.app\nDatenanfragen: privacy@polarfinance.app' },
    ...
    { title: '3. Datenverwendung', body: 'Deine Daten werden ausschließlich zur Bereitstellung und Verbesserung von Polar Finance genutzt. Wir verkaufen deine Daten nie und nutzen sie nicht für Werbung.' },
    ...
    { title: '8. Deine Rechte (DSGVO)', body: 'Du hast das Recht auf Auskunft, Berichtigung, Löschung und Datenübertragbarkeit. E-Mail: privacy@polarfinance.app — Antwort innerhalb von 30 Tagen.' },
    ...
    { title: '10. Kinder', body: 'Polar Finance ist nicht für Personen unter 18 Jahren bestimmt.' },
    { title: '11. Änderungen', body: 'Wir können diese Richtlinie aktualisieren. Die weitere Nutzung gilt als Zustimmung.' },
    { title: '12. Kontakt', body: 'Datenschutz: privacy@polarfinance.app\nAllgemein: contact@polarfinance.app' },
  ],
  it: [
    { title: '1. Chi Siamo', body: 'Polar Finance è un\'applicazione di finanza personale.\n\nContatto: contact@polarfinance.app\nRichieste dati: privacy@polarfinance.app' },
    ...
    { title: '3. Utilizzo dei Dati', body: 'I tuoi dati vengono utilizzati esclusivamente per fornire e migliorare Polar Finance. Non vendiamo mai i tuoi dati né li usiamo per pubblicità.' },
    ...
    { title: '8. I Tuoi Diritti (GDPR)', body: 'Hai il diritto di accedere, correggere, cancellare o portare i tuoi dati. Email: privacy@polarfinance.app — risposta entro 30 giorni.' },
    ...
    { title: '10. Minori', body: 'Polar Finance non è destinato a persone di età inferiore ai 18 anni.' },
    { title: '11. Modifiche', body: 'Potremmo aggiornare questa policy. L\'uso continuato costituisce accettazione.' },
    { title: '12. Contatto', body: 'Privacy: privacy@polarfinance.app\nGenerale: contact@polarfinance.app' },
  ],
  pt: [
    { title: '1. Quem Somos', body: 'Polar Finance é um aplicativo de finanças pessoais.\n\nContato: contact@polarfinance.app\nSolicitações de dados: privacy@polarfinance.app' },
    ...
    { title: '3. Uso dos Dados', body: 'Seus dados são usados exclusivamente para fornecer e melhorar o Polar Finance. Nunca vendemos seus dados nem os usamos para publicidade.' },
    ...
    { title: '8. Seus Direitos (LGPD/GDPR)', body: 'Você tem o direito de acessar, corrigir, excluir ou portar seus dados. E-mail: privacy@polarfinance.app — respondemos em 30 dias.' },
    ...
    { title: '10. Menores', body: 'O Polar Finance não é destinado a menores de 18 anos.' },
    { title: '11. Alterações', body: 'Podemos atualizar esta política. O uso continuado constitui aceitação.' },
    { title: '12. Contato', body: 'Privacidade: privacy@polarfinance.app\nGeral: contact@polarfinance.app' },
  ],
  ar: [
    { title: '١. من نحن', body: 'Polar Finance هو تطبيق للتمويل الشخصي.\n\nالبريد: contact@polarfinance.app\nطلبات البيانات: privacy@polarfinance.app' },
    ...
    { title: '٣. كيف نستخدم بياناتك', body: 'تُستخدم بياناتك فقط لتوفير خدمة Polar Finance وتحسينها. نحن لا نبيع بياناتك ولا نستخدمها للإعلانات.' },
    ...
    { title: '٨. حقوقك', body: 'يحق لك الوصول إلى بياناتك وتصحيحها وحذفها ونقلها. البريد: privacy@polarfinance.app — نرد خلال 30 يوماً.' },
    { title: '٩. الاحتفاظ بالبيانات', body: 'تُحفظ البيانات طالما حسابك نشط. عند الحذف، تُزال جميع البيانات نهائياً خلال 30 يوماً.' },
    { title: '١٠. الأطفال', body: 'Polar Finance ليس مخصصاً لمن هم دون 18 عاماً.' },
    { title: '١١. التغييرات', body: 'قد نحدّث هذه السياسة. الاستمرار في الاستخدام يعني القبول.' },
    { title: '١٢. تواصل معنا', body: 'الخصوصية: privacy@polarfinance.app\nعام: contact@polarfinance.app' },
  ],
  zh: [
    { title: '1. 关于我们', body: 'Polar Finance 是一款个人理财应用程序。\n\n联系方式：contact@polarfinance.app\n数据请求：privacy@polarfinance.app' },
    { title: '2. 我们收集的数据', body: '• 账户数据：电子邮件和加密密码\n• 您手动输入的财务数据\n• 收据图片：由 Claude AI 实时处理——不存储\n• 税务助手数据：仅存储在您的设备本地\n• 匿名崩溃诊断信息\n\n我们不收集生物特征、位置或联系人数据。' },
    { title: '3. 数据使用方式', body: '您的数据仅用于提供和改进 Polar Finance 服务。我们绝不出售您的数据，也不将其用于广告目的。' },
    ...
    { title: '8. 您的权利', body: '您有权访问、更正、删除或转移您的数据。邮箱：privacy@polarfinance.app — 我们将在 30 天内回复。' },
    { title: '9. 数据保留', body: '数据在您的账户有效期内保留。删除账户后，所有数据将在 30 天内被永久删除。' },
    { title: '10. 未成年人', body: 'Polar Finance 不适用于 18 岁以下人士。' },
    { title: '11. 变更', body: '我们可能会更新本政策。继续使用即表示接受。' },
    { title: '12. 联系我们', body: '隐私：privacy@polarfinance.app\n一般：contact@polarfinance.app' },
  ],
  ja: [
    { title: '1. 運営者について', body: 'Polar Finance は個人向け財務管理アプリです。\n\n一般: contact@polarfinance.app\nデータ請求: privacy@polarfinance.app' },
    { title: '2. 収集するデータ', body: '• アカウントデータ：メールアドレスと暗号化パスワード\n• 手動入力した財務データ\n• レシート画像：Claude AI でリアルタイム処理 — 保存しない\n• 税務アシスタントデータ：デバイスローカルのみ\n• 匿名クラッシュ診断\n\n生体認証、位置情報、連絡先は収集しません。' },
    { title: '3. データの利用方法', body: 'データは Polar Finance の提供・改善のためにのみ使用します。販売や広告目的での利用は一切行いません。' },
    ...
    { title: '8. お客様の権利', body: 'データへのアクセス・訂正・削除・移行の権利があります。メール: privacy@polarfinance.app — 30日以内に対応します。' },
    { title: '9. データ保持', body: 'アカウントが有効な間データは保持されます。削除後30日以内にすべてのデータを完全削除します。' },
    { title: '10. 未成年者', body: 'Polar Finance は18歳未満を対象としていません。' },
    { title: '11. 変更', body: 'ポリシーを更新する場合があります。継続使用は同意とみなされます。' },
    { title: '12. お問い合わせ', body: 'プライバシー: privacy@polarfinance.app\n一般: contact@polarfinance.app' },
  ],
};

const TERMS: Record<string, LegalSection[]> = {
  en: [
    { title: '1. Acceptance', body: 'By using Polar Finance, you agree to these Terms of Service. If you do not agree, do not use the app.' },
    ...
    { title: '5. Security', body: 'We implement TLS encryption, AES-256 at rest, secure token storage, rate limiting, and input validation. No system is completely secure — use Polar Finance at your own risk.\n\nReport vulnerabilities to: contact@polarfinance.app' },
    ...
    { title: '7. Intellectual Property', body: 'All content, design, code, and branding are the intellectual property of Polar Finance. You may not reproduce or distribute any part without written permission.' },
    ...
    { title: '11. Contact', body: 'contact@polarfinance.app\n\nWe aim to respond within 5 business days.' },
  ],
  es: [
    { title: '1. Aceptación', body: 'Al usar Polar Finance, aceptas estos Términos de Servicio.' },
    ...
    { title: '5. Seguridad', body: 'Implementamos cifrado TLS, AES-256, almacenamiento seguro de tokens, limitación de intentos y validación de entradas. Informa vulnerabilidades a: contact@polarfinance.app' },
    ...
    { title: '7. Propiedad Intelectual', body: 'Todo el contenido, diseño y código son propiedad intelectual de Polar Finance. No puedes reproducirlos sin permiso escrito.' },
    ...
    { title: '11. Contacto', body: 'contact@polarfinance.app' },
  ],
  fr: [
    { title: '1. Acceptation', body: 'En utilisant Polar Finance, vous acceptez ces Conditions d\'utilisation.' },
    ...
    { title: '5. Sécurité', body: 'Nous mettons en œuvre TLS, AES-256, stockage sécurisé des tokens, limitation du taux et validation des entrées. Signalez les vulnérabilités à: contact@polarfinance.app' },
    ...
    { title: '7. Propriété Intellectuelle', body: 'Tout le contenu, la conception et le code sont la propriété intellectuelle de Polar Finance. Reproduction interdite sans autorisation écrite.' },
  ...
  de: [
    { title: '1. Annahme', body: 'Mit der Nutzung von Polar Finance stimmst du diesen Nutzungsbedingungen zu.' },
    ...
    { title: '5. Sicherheit', body: 'Wir implementieren TLS, AES-256, sichere Token-Speicherung, Rate-Limiting und Eingabevalidierung. Schwachstellen melden an: contact@polarfinance.app' },
    ...
    { title: '7. Geistiges Eigentum', body: 'Alle Inhalte, Designs und Code sind geistiges Eigentum von Polar Finance. Vervielfältigung ohne schriftliche Genehmigung ist untersagt.' },
    ...
    { title: '11. Kontakt', body: 'contact@polarfinance.app' },
  ],
  it: [
    { title: '1. Accettazione', body: 'Utilizzando Polar Finance, accetti questi Termini di Servizio.' },
    ...
    { title: '5. Sicurezza', body: 'Implementiamo TLS, AES-256, archiviazione sicura dei token, limitazione dei tentativi e validazione degli input. Segnala vulnerabilità a: contact@polarfinance.app' },
    ...
    { title: '7. Proprietà Intellettuale', body: 'Tutti i contenuti, il design e il codice sono proprietà intellettuale di Polar Finance. La riproduzione senza autorizzazione scritta è vietata.' },
    ...
    { title: '11. Contatto', body: 'contact@polarfinance.app' },
  ],
  pt: [
    { title: '1. Aceitação', body: 'Ao usar o Polar Finance, você concorda com estes Termos de Serviço.' },
    ...
    { title: '5. Segurança', body: 'Implementamos TLS, AES-256, armazenamento seguro de tokens, limitação de tentativas e validação de entradas. Reporte vulnerabilidades para: contact@polarfinance.app' },
    ...
    { title: '7. Propriedade Intelectual', body: 'Todo o conteúdo, design e código são propriedade intelectual do Polar Finance. A reprodução sem permissão escrita é proibida.' },
    ...
    { title: '11. Contato', body: 'contact@polarfinance.app' },
  ],
  ar: [
    { title: '١. القبول', body: 'باستخدامك Polar Finance، فإنك توافق على شروط الخدمة هذه.' },
    ...
    { title: '٥. الأمان', body: 'نطبق تشفير TLS وAES-256 وتخزين رموز آمنة وتحديد معدل المحاولات والتحقق من المدخلات. أبلغ عن الثغرات على: contact@polarfinance.app' },
    ...
    { title: '٧. الملكية الفكرية', body: 'جميع المحتويات والتصميمات والأكواد هي ملكية فكرية لـ Polar Finance. لا يجوز نسخها أو توزيعها بدون إذن كتابي.' },
    ...
    { title: '١١. تواصل معنا', body: 'contact@polarfinance.app' },
  ],
  zh: [
    { title: '1. 接受条款', body: '使用 Polar Finance 即表示您同意这些服务条款。' },
    ...
    { title: '5. 安全性', body: '我们实施 TLS 加密、AES-256 静态加密、安全令牌存储、速率限制和输入验证。如发现安全漏洞，请报告至：contact@polarfinance.app' },
    { title: '6. 订阅与付款', body: '付费套餐通过 App Store 或 Google Play 管理。除非在续订日期前 24 小时取消，否则订阅将自动续订。我们不存储支付卡信息。' },
    { title: '7. 知识产权', body: 'Polar Finance 的所有内容、设计和代码均为其知识产权。未经书面许可，不得复制或分发。' },
    ...
    { title: '11. 联系方式', body: 'contact@polarfinance.app' },
  ],
  ja: [
    { title: '1. 同意', body: 'Polar Finance を使用することで、本利用規約に同意したものとみなされます。' },
    ...
    { title: '5. セキュリティ', body: 'TLS暗号化、AES-256静的暗号化、セキュアトークン保存、レート制限、入力バリデーションを実装しています。脆弱性の報告先: contact@polarfinance.app' },
    { title: '6. サブスクリプションと支払い', body: '有料プランはApp StoreまたはGoogle Play経由で管理されます。更新日の24時間前にキャンセルしない限り、サブスクリプションは自動更新されます。支払い情報は保存しません。' },
    { title: '7. 知的財産', body: 'すべてのコンテンツ、デザイン、コードはPolar Financeの知的財産です。書面による許可なく複製・配布することはできません。' },
    ...
    { title: '11. お問い合わせ', body: 'contact@polarfinance.app' },
  ],
};
...
export default function SettingsScreen() {
  ...
  const handleFeedback = () => {
    Linking.openURL('mailto:contact@polarfinance.app?subject=Polar Finance Feedback')
      .catch(() => Alert.alert('Feedback', 'Send your thoughts to contact@polarfinance.app'));
  };

  const planLabel = plan === 'free' ? t('freePlan') : plan === 'trial' ? t('trialPlan') : plan === 'pro' ? t('proPlan') : t('premiumPlan');
  const planIcon = plan === 'free' ? 'person-outline' : plan === 'trial' ? 'ribbon' : plan === 'pro' ? 'flash' : 'ribbon';
    ...
    <ScrollView style={{ flex: 1, backgroundColor: c.dark, paddingHorizontal: 20 }} showsVerticalScrollIndicator={false}>
      ...
      <TouchableOpacity
        ...
        <View style={{ width: 46, height: 46, borderRadius: 14, backgroundColor: c.accent + '18', justifyContent: 'center', alignItems: 'center' }}>
          <Ionicons name={planIcon as any} size={24} color={c.accent} />
        </View>
        <View style={{ flex: 1 }}>
      ...
      <View style={{ backgroundColor: c.card, borderRadius: 20, marginBottom: 20, borderWidth: 1, borderColor: c.border, overflow: 'hidden' }}>
        ...
        <TouchableOpacity onPress={() => Linking.openURL('https://www.instagram.com/polarfinance.app?igsh=bGZpY241ZWlkbGVr').catch(() => { })}
        ...
        <TouchableOpacity onPress={() => Linking.openURL('https://www.tiktok.com/@polarfinance.app?_r=1&_t=ZN-94NjuWv6IvW').catch(() => { })}
          style={{ flexDirection: 'row', alignItems: 'center', padding: 16, borderTopWidth: 1, borderTopColor: c.border, gap: 14 }}>
        ...
        <TouchableOpacity onPress={() => Linking.openURL('https://x.com/polarfinanceapp?s=21&t=6MLXzsUFO0HYhevUrJI7xQ').catch(() => { })}
          style={{ flexDirection: 'row', alignItems: 'center', padding: 16, borderTopWidth: 1, borderTopColor: c.border, gap: 14 }}>
      ...
      {/* ── Log Out ── */}
      <TouchableOpacity
        style={{ backgroundColor: '#FF6B6B18', borderRadius: 16, padding: 16, alignItems: 'center', borderWidth: 1, borderColor: '#FF6B6B44', marginBottom: 24, flexDirection: 'row', justifyContent: 'center', gap: 10 }}
